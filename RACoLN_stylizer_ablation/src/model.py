...
#         style = hidden[:,:self.y_dim]
        return hidden, output, attn_hidden, src_mask, reverse_scores
...
class DecoderRNN_LN(BaseRNN):
    ...
    def __init__(self, vocab_size, max_len, hidden_size,
        ...
        self.emb_dim = 128
        self.rnn = self.rnn_cell(self.emb_dim, hidden_size, n_layers, batch_first=True)
        ...
        self.stylizer = nn.Embedding(num_class, style_size)
    ...
    def forward(self, inputs=None, encoder_hidden=None, encoder_outputs=None,
        ...
        #style_vec = nn.Embedding(2, style_size)

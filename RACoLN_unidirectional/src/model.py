...
class EncoderRNN(nn.Module):
    def __init__(self, input_size, embedding_dim, hidden_size, padding_idx, n_layers=1, dropout = 0.4, bidirectional = False, discriminator=False):
...
class DecoderRNN_LN(BaseRNN):
    ...
    def forward(self, inputs=None, encoder_hidden=None, encoder_outputs=None,
        ...
        #print(f'attn_hidden.shape: {attn_hidden.shape}')
